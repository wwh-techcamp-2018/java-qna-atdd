...
INSERT INTO user (id, user_id, password, name, email, created_at) values (3, 'gusdk', '1234', 'gusdk1234', 'tech_hak@woowahan.com', CURRENT_TIMESTAMP());
INSERT INTO user (id, user_id, password, name, email, created_at) values (4, 'alstjr', '1234', 'alstjr1234', 'tech_mss@woowahan.com', CURRENT_TIMESTAMP());
