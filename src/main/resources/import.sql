...
INSERT INTO user (id, user_id, password, name, email, created_at) values (3, 'doy', 'test', '도이', 'doy@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO user (id, user_id, password, name, email, created_at) values (4, 'dooho', 'test', '두호', 'dooho@slipp.net', CURRENT_TIMESTAMP());
