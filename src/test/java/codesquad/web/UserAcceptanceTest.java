...
public class UserAcceptanceTest extends AcceptanceTest {
    ...
    public void create() throws Exception {
        ...
        HttpEntity<MultiValueMap<String, Object>> httpEntity = HtmlFormDataBuilder.urlEncodedForm().addParameter("userId", userId)
                .addParameter("password", "password")
                .addParameter("name", "자바지기")
                .addParameter("email", "javajigi@slipp.net")
                .build();

        ResponseEntity<String> response = template().postForEntity("/users", httpEntity, String.class);
    ...
    private ResponseEntity<String> update(TestRestTemplate template) throws Exception {
        ...
        HttpEntity<MultiValueMap<String, Object>> request = HtmlFormDataBuilder.urlEncodedForm().addParameter("_method", "put")
